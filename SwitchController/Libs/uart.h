...
LICENSE:
    Copyright (C) 2015 Peter Fleury //Modified by Kutukov Pavel//, GNU General Public License Version 3
...
#define ENABLE_UART_EXTENSIONS 1
...
/**
 *  @brief   Get received byte from ringbuffer without removal
 *
 * Returns in the lower byte the received character and in the
 * higher byte the last receive error.
 * UART_NO_DATA is returned when no data is available.
 ...
 *             <br>Framing Error by UART
 */
extern unsigned int uart_peek(void);
 ...
 */
#define uart_puts_P(__s)       uart_puts_p(PSTR_L(__s))

/************************************************************************/
/* Sending complete                                                     */
/************************************************************************/
extern bool uart_ready(void);

#if ENABLE_UART_EXTENSIONS
/************************************************************************/
/*                                                                      */
/************************************************************************/
extern void uart_puts_E(const uint8_t* e, uint8_t sz);
/************************************************************************/
/*                                                                      */
/************************************************************************/
extern void uart_puts_EP(const uint8_t* const* p, uint8_t sz);
/************************************************************************/
/* Sets Tail = Head (of the buffer)                                     */
/************************************************************************/
#endif
